(function() {
  ...
  addLesson({
    ...
    structures: [
      ...
      {
        structure: "Well, quite honestly I don’t think I’ve ever thought about that, but I guess _______",
        ...
        examples: [
          "Well, quite honestly I don’t think I’ve ever thought about that, but I guess it would be fun. (Честно говоря, я не думаю, что когда-либо об этом задумывался, но, полагаю, это было бы весело.)",
          "Well, quite honestly I don’t think I’ve ever thought about that, but I guess it’s a good idea. (Честно говоря, я не думаю, что когда-либо об этом задумывался, но, полагаю, это хорошая идея.)",
          "Well, quite honestly I don’t think I’ve ever thought about that, but I guess I’d enjoy it. (Честно говоря, я не думаю, что когда-либо об этом задумывался, но, полагаю, мне бы это понравилось.)"
        ],
      ...
      {
        structure: "Actually, this isn’t something that I’ve ever considered, but in short ________",
        ...
        examples: [
          "Actually, this isn’t something that I’ve ever considered, but in short it sounds exciting. (На самом деле, это не то, о чём я когда-либо думал, но, вкратце, это звучит захватывающе.)",
          "Actually, this isn’t something that I’ve ever considered, but in short it’s worth trying. (На самом деле, это не то, о чём я когда-либо думал, но, вкратце, это стоит попробовать.)",
          "Actually, this isn’t something that I’ve ever considered, but in short I’d give it a shot. (На самом деле, это не то, о чём я когда-либо думал, но, вкратце, я бы попробовал.)"
        ],
      ...
      {
        structure: "I am not really sure how to put this, but I suppose generally speaking _______",
        ...
        examples: [
          "I am not really sure how to put this, but I suppose generally speaking it would be great. (Я не совсем уверен, как это выразить, но, в общем, полагаю, это было бы здорово.)",
          "I am not really sure how to put this, but I suppose generally speaking it’s interesting. (Я не совсем уверен, как это выразить, но, в общем, полагаю, это интересно.)",
          "I am not really sure how to put this, but I suppose generally speaking I’d try it. (Я не совсем уверен, как это выразить, но, в общем, полагаю, я бы попробовал.)"
        ],
    ...
    validateStructure: function(text, structure) {
      ...
      switch (structure.id) {
        ...
        case "well-quite-honestly-i-dont-think":
          minWords = 17; // well quite honestly i do not think i have ever thought about that but i guess reason
          break;
        case "actually-this-isnt-something":
          minWords = 14; // actually this is not something that i have ever considered but in short reason
          break;
        case "i-am-not-really-sure":
          minWords = 15; // i am not really sure how to put this but i suppose generally speaking reason
          break;
        default:
          minWords = 5;
      }
