addLesson({
  level: "beginner2",
  lesson: "lesson31",
  name: "Урок 31: Do you have any _____? / Yes, I have some ______ / No, I do not have any ______.",
  structures: [
    {
      structure: "Do you have any _____?",
      pattern: ["do", "have"],
      translations: ["У тебя есть какие-нибудь _____?"],
      examples: [
        "Do you have any books? (У тебя есть какие-нибудь книги?)",
        "Do you have any water? (У тебя есть вода?)",
        "Do you have any pencils? (У тебя есть карандаши?)",
        "Do you have any food? (У тебя есть еда?)"
      ],
      id: "do-you-have-any-noun",
      hasVerb: true,
      hasName: false
    },
    {
      structure: "Yes, I have some ______.",
      pattern: ["yes", "have"],
      translations: ["Да, у меня есть немного ______."],
      examples: [
        "Yes, I have some books. (Да, у меня есть книги.)",
        "Yes, I have some water. (Да, у меня есть вода.)",
        "Yes, I have some pencils. (Да, у меня есть карандаши.)",
        "Yes, I have some food. (Да, у меня есть еда.)"
      ],
      id: "yes-i-have-some-noun",
      hasVerb: true,
      hasName: false
    },
    {
      structure: "No, I do not have any ______.",
      pattern: ["no", "do", "not", "have"],
      translations: ["Нет, у меня нет никаких ______."],
      examples: [
        "No, I do not have any books. (Нет, у меня нет книг.)",
        "No, I do not have any water. (Нет, у меня нет воды.)",
        "No, I do not have any pencils. (Нет, у меня нет карандашей.)",
        "No, I do not have any food. (Нет, у меня нет еды.)"
      ],
      id: "no-i-do-not-have-any-noun",
      hasVerb: true,
      hasName: false
    }
  ],
  ...
  validateStructure: function(text, structure) {
    ...
    // Заменяем сокращение "don't" на "do not"
    let processedText = text.replace(/don't/gi, 'do not');
    ...
    if (structure.id === "do-you-have-any-noun") {
      // Проверяем "do"
      if (!words[wordIndex] || words[wordIndex] !== 'do') {
      ...
      return validateNoun();
    } else if (structure.id === "yes-i-have-some-noun") {
      // Проверяем "yes"
      ...
      // Проверяем существительное
      return validateNoun();
    } else if (structure.id === "no-i-do-not-have-any-noun") {
      // Проверяем "no"
